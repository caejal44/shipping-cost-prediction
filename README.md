# Multi-Carrier Shipping Cost Predictor
A machine learning–powered decision-support tool that helps users estimate and compare shipping costs across carriers.

Rather than returning a single prediction, this application evaluates multiple carriers and provides **cost, transit, and data-backed insights** for real-world decision-making.

Built on a synthetic logistics dataset generated via a companion simulation engine.
...
4. **Rank carriers**  
   - Sorted by lowest predicted cost  
...
This application uses a synthetic logistics dataset generated by a companion simulation project:

👉 https://github.com/caejal44/shipping-cost-data-simulation

The simulator models realistic carrier pricing behavior, transit times, and lane coverage to support training and evaluation of the ML pipeline.
